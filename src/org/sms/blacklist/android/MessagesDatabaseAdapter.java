...
public class MessagesDatabaseAdapter {
	...
	public void deleteMessage(int messageId) {
		db.delete(Constants.DATABASES_TABLE_MESSAGES, KEY_MESSAGEID + "="
				+ messageId, null);
	}
	...
	public Cursor getAllMessages() {
		return db.query(Constants.DATABASES_TABLE_MESSAGES,
				new String[] { KEY_MESSAGEID, KEY_TIMESTAMP, KEY_NUMBER,
						KEY_BODY, KEY_UNREAD }, null, null, null, null,
				"timestamp DESC");
	}
	...
	public Cursor getMessage(int messageId) throws SQLException {
		Cursor mCursor = db
				.query(true, Constants.DATABASES_TABLE_MESSAGES, new String[] {
						KEY_TIMESTAMP, KEY_NUMBER, KEY_BODY, KEY_UNREAD },
						KEY_MESSAGEID + "=" + messageId, null, null, null,
						null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();
		}
	...
	public void markRead(int messageId) {
		...
		db.update(Constants.DATABASES_TABLE_MESSAGES, args, KEY_MESSAGEID + "="
				+ messageId, null);
	}
